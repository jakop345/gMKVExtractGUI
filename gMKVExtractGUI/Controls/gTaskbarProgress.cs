...
namespace gMKVToolNix
{
    public static class gTaskbarProgress
    {
        ...
        public static void SetOverlayIcon(Form frm, System.Drawing.Icon icn, String description)
        {
            ...
            {
                Debug.WriteLine(String.Format("{1}: HRESULT:0x{0:X8}", Instance().SetOverlayIcon(frm.Handle, icn == null ? IntPtr.Zero : icn.Handle, description == null ? String.Empty : description), description == null ? String.Empty : description));
            }
        }
    }
}
